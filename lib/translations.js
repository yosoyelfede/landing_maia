const translations = {
  ...
  hero: {
    es: {
      ...
      description: 'Transforma tu sitio en tu asistente 24/7: atiende, informa y prioriza tus mejores oportunidades.',
      cta: '¡Quiero recuperar tiempo perdido!',
      demoTitle: 'Demo de Maia'
    },
    en: {
      heading: 'Save time. <span>Close more.</span>',
  ...
  keyValues: {
    es: {
      ...
      description: 'Muchas horas al día se pierden respondiendo las mismas preguntas. Maia lo hace automáticamente con IA, incluso cuando tú no estás disponible.',
  ...
  finalCTA: {
    es: {
      ...
      description: 'Empieza hoy y descubre cómo Maia te pone un asistente inteligente que trabaja mientras tú decides.',
      ctaButton: '¡Quiero recuperar tiempo perdido!'
    },
    en: {
      heading: 'Less time on administrative tasks. More time closing.',
      description: 'Start today and discover how Maia gives you a smart assistant that works while you decide.',
    ...
    en: {
      ...
      blogPosts: {
        ...
        recorridoInteligente: {
          ...
          description: 'An intelligent tour doesn\'t just show. It guides, converses, and sells. Discover how to transform any virtual tour into a sales tool with AI, without redoing anything.'
        }
      }
    }
  },

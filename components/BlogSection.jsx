  ...
  const getBlogPosts = () => {
    ...
    if (content.blogPosts.queDeberiaHacerUnaInmobiliaria) {
      posts.push({
        ...
        description: content.blogPosts.queDeberiaHacerUnaInmobiliaria.description,
        date: '12 Agosto 2025', // This should match the date in blog.posts
        image: "/images/blog/que-deberia-hacer-una-inmobiliaria.jpg"
      });
    }
    ...
    if (content.blogPosts.metricasRecorridoVirtual) {
      posts.push({
        ...
        date: '6 Agosto 2025', // This should match the date in blog.posts
    ...
    if (content.blogPosts.leadsNoCalificados) {
      posts.push({
        ...
        date: '30 Julio 2025', // This should match the date in blog.posts
    ...
    if (content.blogPosts.nadieQuiereDejarSusDatos) {
      posts.push({
        ...
        date: '23 Julio 2025', // This should match the date in blog.posts
    ...
    if (content.blogPosts.paraQueSirveUnRecorridoVirtual) {
      posts.push({
        ...
        date: '16 Julio 2025', // This should match the date in blog.posts
    ...
    if (content.blogPosts.recorridosQueVenden) {
      posts.push({
        ...
        date: '9 Julio 2025', // This should match the date in blog.posts
    ...
    if (content.blogPosts.recorridoInteligente) {
      posts.push({
        ...
        date: '2 Julio 2025', // This should match the date in blog.posts
    ...
    if (content.blogPosts.renderVsVirtualTour) {
      posts.push({
        ...
        date: '25 Junio 2025', // This should match the date in blog.posts

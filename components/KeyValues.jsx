      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-24 rounded-2xl overflow-hidden bg-white shadow-xl border border-gray-100">
          ...
          <div className="p-8 lg:p-12">
            ...
            <h3 className="text-2xl font-bold mb-4 text-gray-900">Asistente AI en tus recorridos virtuales</h3>
            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
              Nuestro asistente AI guía a tus potenciales clientes a través de los espacios, 
